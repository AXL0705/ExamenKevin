<div class="container">
    <a type="button" class="btn btn-success mb-3 float-right" href="{{route('empleados.create')}}"><i class="fas fa-user-plus"></i></a>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                ...
                <a type="button" class="btn btn-success btn-sm " href="{{route('empleados.editar',$empleado)}}"><i class="fas fa-user-edit"></i></a>
